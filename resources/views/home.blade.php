...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('page/fonts/ionicons/css/ionicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('page/fonts/fontawesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('page/fonts/flaticon/font/flaticon.css')}}">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            ...
            <ul class="navbar-nav absolute-right">
              <li class="nav-item">
                <a href="{{ route('login') }}" class="nav-link text-secondary">LOGIN  <i class="fa fa-arrow-right"></i></a>
              </li>
              <li class="nav-item">
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url({{asset('page/images/big_image_1.jpg')}});">
      <div class="container">
    ...
    <!-- <section class="school-features d-flex" style="background-image: url({{asset('page/images/big_image_3.jpg')}});">
    ...
    <section class="site-section bg-light">
      <div class="container">
        ...
        <div class="row top-course">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{asset('page/images/javascript.jpg')}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{asset('page/images/photoshop.jpg')}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{asset('page/images/reactjs.jpg')}}" alt="Image placeholder">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              <img src="{{asset('page/images/angularjs.jpg')}}" alt="Image placeholder">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="{{asset('page/js/jquery-3.2.1.min.js')}}"></script>
    <script src="{{asset('page/js/jquery-migrate-3.0.0.js')}}"></script>
